    ...
    themes: [
      {
        ...
        responses: [
          { id: "r1", text: "I love Coke, it's refreshing", code: "COLA_COKE", sentiment: "positive" },
          { id: "r2", text: "Coca-Cola is the best", code: "COLA_COKE", sentiment: "positive" },
          { id: "r3", text: "Pepsi all the way", code: "COLA_PEPSI", sentiment: "positive" },
          { id: "r4", text: "I prefer Coca Cola over others", code: "COLA_COKE", sentiment: "neutral" },
        ],
      },
      {
        id: "t2",
        ...
        responses: [
          { id: "r5", text: "Sprite is my favorite", code: "LEMON_LIME_SPRITE", sentiment: "positive" },
          { id: "r6", text: "Mountain Dew for the energy", code: "CITRUS_MDEW", sentiment: "positive" },
          { id: "r7", text: "I like Fanta orange", code: "FRUIT_FANTA", sentiment: "positive" },
        ],
      },
      {
        id: "t3",
        ...
        responses: [
          { id: "r8", text: "I avoid soft drinks, they're unhealthy", code: "HEALTH_AVOID", sentiment: "negative" },
          { id: "r9", text: "Only sugar-free options for me", code: "HEALTH_SUGAR_FREE", sentiment: "neutral" },
          { id: "r10", text: "I switched to sparkling water", code: "HEALTH_ALTERNATIVE", sentiment: "neutral" },
        ],
      },
      {
        id: "t6",
        ...
        responses: [
          { id: "r17", text: "Sprite is my favorite", code: "BRAND_SPRITE", sentiment: "positive" },
          { id: "r18", text: "Mountain Dew for the energy", code: "BRAND_MDEW", sentiment: "positive" },
          { id: "r19", text: "I like Fanta orange", code: "BRAND_FANTA", sentiment: "positive" },
          { id: "r20", text: "Dr Pepper has a unique taste", code: "BRAND_DRPEPPER", sentiment: "neutral" },
          { id: "r21", text: "7UP is so refreshing", code: "BRAND_7UP", sentiment: "positive" },
        ],
      },
    ],
  },
    ...
    themes: [
      {
        ...
        responses: [
          { id: "r11", text: "Price is the main factor", code: "FACTOR_PRICE", sentiment: "neutral" },
          { id: "r12", text: "I look for discounts and deals", code: "FACTOR_DEALS", sentiment: "positive" },
          { id: "r13", text: "Affordable options are important", code: "FACTOR_AFFORDABILITY", sentiment: "neutral" },
        ],
      },
      {
        id: "t5",
        ...
        responses: [
          { id: "r14", text: "I stick to brands I trust", code: "FACTOR_TRUST", sentiment: "positive" },
          { id: "r15", text: "Brand reputation matters", code: "FACTOR_REPUTATION", sentiment: "neutral" },
          { id: "r16", text: "I'm loyal to my favorite brand", code: "FACTOR_LOYALTY", sentiment: "positive" },
        ],
      },
    ],
  },
